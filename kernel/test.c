...
void console_putbytes(const char *chaine, unsigned long taille);
void cons_write(const char *str, unsigned long size){console_putbytes(str, size);};
int cons_read(char *str, unsigned long size){(void)str, (void)size; return 0;};
void cons_echo(int on){(void)on;};
